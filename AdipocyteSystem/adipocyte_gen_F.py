...
from AdipocyteSystem import adipocyte_de_config
...
if __name__ == '__main__':
    aliases_str, des_str = adipocyte_de_config.aliases_, adipocyte_de_config.des_str_
    ...
    # pprint(des_str)
    gen_python_code(gen_file = os.path.join(adipocyte_de_config.write_generated_code_to, adipocyte_de_config.name_of_generated_pyhton_file),
                    des_dict_=des_str,
                    sys_funcs= adipocyte_de_config.system_functions,
                    from_y_name_to_source_name=map_to_source_name)
    create_dir_if_not_exist(config.adipocyte_translators_of_names_path)
    torch.save(obj=to_new_var_name, f=config.adipocyte_map_from_old_param_name_to_new_name_dict_filename)
    torch.save(obj=map_to_Y_name, f=config.adipocyte_map_from_old_y_name_to_new_name_dict_filename)
    ...
    view.render(path_to_rendered_html=os.path.join(adipocyte_de_config.write_latex_view_of_system_to,'equations.html'))
