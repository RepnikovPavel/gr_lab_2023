...
free_functions = {
    r'f': {'py_name': 'sigmoid', 'params': ''}
}
external_links = {
    r'[KB-plasma]': {'py_name': 'KB_plasma', 'params': 't'},
    r'F_carb': {'py_name': 'F_carb', 'params': 't'},
    r'F_fat': {'py_name': 'F_fat', 'params': 't'},
    r'F_prot': {'py_name': 'F_prot', 'params': 't'},
    r'[SP]_{myo}': {'py_name': 'SP_myo', 'params': 't'}
}
...
aliases_ = {
    ...
    '@M_12@': r'#f([INS],$\alpha_12$,$\beta_12$,$\gamma_12$,$\delta_12$)#*#f([Ac-CoA]_{myo},$\alpha_12_2$,$\beta_12_2$,'
              r'$\gamma_12_2$, $\delta_12_2$)#*[Pyr]_{myo}',
...
des_str_ = {
    # для нутриентов
    'D_{carb}': r'($a_{carb}$ * #F_{carb}# - D_{carb}) / $\tau_{carb}$',
    'J_{carb}': r'(D_{carb} - J_{carb}) / $]tau_{carb}$',
    'D_{fat}': r'($a_{fat}$ * #F_{fat}# - D_{fat}) / $\tau_{fat}$',
    'J_{fat}': r'(D_{fat} - J_{fat}) / $\tau_{fat}$',
    'D_{prot}': r'($a_{prot}$ * #F_{prot}# - D_{prot}) / $\tau_{prot}$',
